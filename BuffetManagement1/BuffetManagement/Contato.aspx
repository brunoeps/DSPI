...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        ...
        <div class="col-sm-4">
            <h1>Contato</h1>
            <p class="lead">Nome:</p>
            <asp:TextBox runat="server" ID="txtNomeRemetente" CssClass="form-control" placeholder="Digite seu nome"></asp:TextBox><br />
            <p class="lead">Assunto:</p>
            <asp:DropDownList runat="server" ID="ddlAssunto" AutoPostBack="true" CssClass="form-control">
            ...
            <asp:TextBox runat="server" ID="txtEmailContato" CssClass="form-control" placeholder="Digite seu e-mail de contato"></asp:TextBox><br />
