...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
        ...
        <h1>Clientes</h1>
        <p class="lead">Nome:</p>
        <asp:TextBox runat="server" ID="txtNomeCliente" CssClass="form-control" Style="margin-left: 390px" placeholder="Insira o nome do cliente"></asp:TextBox><br />
        <p class="lead">CPF:</p>
        <asp:TextBox runat="server" ID="txtCPFCliente" CssClass="form-control" Style="margin-left: 390px" placeholder="Insira o CPF do cliente"></asp:TextBox><br />
        <p class="lead">Telefone:</p>
        <asp:TextBox runat="server" ID="txtTelefoneCliente" CssClass="form-control" Style="margin-left: 390px" placeholder="Insira o telefone do cliente"></asp:TextBox><br />
        <br />
        ...
        <asp:Button runat="server" ID="btnCadastraCliente" Text="Cadastrar" class="button" OnClick="btnCadastraCliente_Click" />
        <asp:Button runat="server" ID="btnPesquisaCliente" Text="Pesquisar" class="button" OnClick="btnPesquisaCliente_Click" />
